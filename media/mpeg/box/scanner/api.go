...
// New creates a new Scanner for reading mpeg data streams
func New(r io.ReadSeeker) Scanner {
	return &scanner{r}
}

// ScanAllChildren scans the data stream for `knownChildren`.
// Returns a slice of box.Boxed containing found children.
...
// ScanFor scans the data stream for a single Box.
